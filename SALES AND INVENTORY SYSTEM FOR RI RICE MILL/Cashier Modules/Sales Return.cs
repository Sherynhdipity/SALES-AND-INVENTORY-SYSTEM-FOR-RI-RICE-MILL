    ...
    public partial class frmSalesReturn : Form
    {
        ...
        public void DisplayItems()
        {
            try
            {
                ...
                {
                    con.Open();
                    QuerySelect = "SELECT id as 'ID', Description as 'Description', Price as 'Price', Critical_level as 'Critical Level' FROM tblItems WHERE id " +
                        "LIKE '"+txtViewItem.Text+"%' " +
                    ...
                    cmd.Parameters.AddWithValue("@fName", txtViewItem.Text);
